...
SELECT
    ...
    CASE 
        ...
        WHEN sms_type = '促活' AND brand = 'MG' THEN '002011005010_tp'
        WHEN brand = 'MG' THEN '002011005007_tp'
        WHEN sms_type = '活动' AND brand = 'RW' THEN '002005006001_rw'
        WHEN sms_type = '服务' AND brand = 'RW' THEN '002005006002_rw'
        WHEN sms_type = '潜客' AND brand = 'RW' THEN '002005006003_rw'
        WHEN sms_type = '推介' AND brand = 'RW' THEN '002005006004_rw'
        WHEN sms_type = '挽回' AND brand = 'RW' THEN '002005006005_rw'
        WHEN sms_type = '增换购' AND brand = 'RW' THEN '002005006006_rw'
        WHEN sms_type = '调研' AND brand = 'RW' THEN '002005006008_rw'
        WHEN sms_type = '保客' AND brand = 'RW' THEN '002005006009_rw'
        WHEN sms_type = '促活' AND brand = 'RW' THEN '002005006010_rw'
        WHEN brand = 'RW' THEN '002005006007_rw' 
    END AS touchpoint_id,
    sms_type,
    sms_name,
    action_time,
