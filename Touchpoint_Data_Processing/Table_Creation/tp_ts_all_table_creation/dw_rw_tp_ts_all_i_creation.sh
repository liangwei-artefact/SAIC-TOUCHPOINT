#!/bin/bash
#/*********************************************************************
#*程序名  : dw_rw_tp_ts_all_i_creation.sh
#*功能    : 定义RW触点小宽表聚合表Schema
#*开发人  : Rickena Li
#*开发日期: 2021-08-16
#*修改记录:
#*
...
hive -e "
DROP TABLE IF EXISTS marketing_modeling.dw_rw_tp_ts_all_i;
CREATE EXTERNAL TABLE IF NOT EXISTS marketing_modeling.dw_rw_tp_ts_all_i (
